...
const ContainerEnded: React.FC<Props> = ({ data }) => {
  return (
    <div className="w-full h-full flex flex-col items-start bg-gray-500 p-2">
      <div className="flex flex-row mb-5">
        <h1 className="text-red-100 text-lg font-bold">Ended Classes : </h1>
