...
const ContainerOngoing: React.FC<Props> = ({ data }) => {
  return (
    <div className="w-full h-full flex flex-col items-start bg-yellow-500 p-2">
      <div className="flex flex-row mb-5">
        <h1 className="text-red-100 text-lg font-bold">Ongoing Classes : </h1>
...
export default ContainerOngoing;
